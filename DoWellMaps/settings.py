"""
Django settings for DoWellMaps project.
...
SECRET_KEY = 'django-insecure-n%p=kbhjj!^um&r%jpmwp2o2+v546-n005$s%e!-=@x^c!jbrk'
...
WSGI_APPLICATION = 'DoWellMaps.wsgi.application'
